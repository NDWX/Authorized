...
public class WebApiHandler
{
	...
	public async Task<IResult> GetEffectivePermissionAsync(
		[Required, FromHeader] string purpose,
	...
	public async Task<IResult> GetAccessControlListsAsync(
		[Required, FromHeader] string purpose,
		[Required, FromRoute] string domain,
		[Required, FromRoute] string objectType,
		[Required, FromRoute] string objectIdentifier
	)
	{
		IDictionary<Noun, IEnumerable<AccessControlEntry>>? accessControlLists =
			await _authorized.GetAccessControlListsAsync(
				...
				{
					Domain = domain,
					Type = objectType, Identifier = objectIdentifier
				}
			);
	...
	public async Task<IResult> GetAccessControlEntriesAsync(
		[Required, FromHeader] string purpose,
		[Required, FromRoute] string domain,
		[Required, FromRoute] string objectType,
		[Required, FromRoute] string objectIdentifier,
	...
	public async Task<IResult> SetSubjectAccessControlEntries(
		[Required, FromHeader] string purpose,
		[Required, FromRoute] string domain,
		[Required, FromRoute] string objectType,
		[Required, FromRoute] string objectIdentifier,
	...
	[ProducesResponseType( StatusCodes.Status403Forbidden )]
	[ProducesResponseType( StatusCodes.Status200OK )]
	public async Task<IResult> SetAccessControlListsAsync(
		[Required, FromHeader] string purpose,
		[Required, FromRoute] string domain,
		[Required, FromRoute] string objectType,
		[Required, FromRoute] string objectIdentifier,
