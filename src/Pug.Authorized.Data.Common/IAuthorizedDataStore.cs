...
namespace Pug.Authorized.Data
{
	...
	{
		Task<IEnumerable<AccessControlEntry>> GetAccessControlEntriesAsync( string purpose, DomainObject domainObject,
																			Noun subject,
																			string action = null );
		
		Task<IDictionary<Noun, IEnumerable<AccessControlEntry>>> GetAccessControlListsAsync( string purpose, DomainObject domainObject);
